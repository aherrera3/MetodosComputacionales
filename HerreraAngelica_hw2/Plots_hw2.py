...
plt.subplot(3,3,5)
plt.plot(x2_, y2_, c="b")
plt.title("leap-frog dt=0.001")
plt.xlabel("x [UA]")
plt.grid()

plt.subplot(3,3,6)
plt.plot(x3_, y3_, c="b")
plt.title("leap-frog dt=0.0001")
plt.xlabel("x [UA]")
plt.grid()

plt.subplot(3,3,7)
plt.plot(_x1_, _y1_, c="r")
...
plt.subplot(3,3,8)
plt.plot(_x2_, _y2_, c="r")
plt.title("runge-kutta dt=0.001")
plt.xlabel("x [UA]")
plt.grid()

plt.subplot(3,3,9)
plt.plot(_x3_, _y3_,c="r")
...
plt.subplot(3,3,2)
plt.plot(vx2, vy2, c="c")
plt.title("euler dt=0.001")
plt.xlabel("vx [UA/años]")
plt.grid()

plt.subplot(3,3,3)
plt.plot(vx3, vy3, c="c")
plt.title("euler dt=0.0001")
plt.xlabel("vx [UA/años]")
plt.grid()

plt.subplot(3,3,4)
plt.plot(vx1_, vy1_, c="b")
plt.title("leap-frog dt=0.01")
plt.ylabel("vy [UA/años]")
plt.xlabel("vx [UA/años]")
plt.grid()
...
plt.subplot(3,3,5)
plt.plot(vx2_, vy2_, c="b")
plt.title("leap-frog dt=0.001")
plt.xlabel("vx [UA/años]")
plt.grid()

plt.subplot(3,3,6)
plt.plot(vx3_, vy3_, c="b")
plt.title("leap-frog dt=0.0001")
plt.xlabel("vx [UA/años]")
plt.grid()

plt.subplot(3,3,7)
plt.plot(_vx1_, _vy1_, c="r")
plt.title("runge-kutta dt=0.01")
plt.ylabel("vy [UA/años]")
plt.xlabel("vx [UA/años]")
plt.grid()
...
plt.subplot(3,3,8)
plt.plot(_vx2_, _vy2_, c="r")
plt.title("runge-kutta dt=0.001")
plt.xlabel("vx [UA/años]")
plt.grid()

plt.subplot(3,3,9)
plt.plot(_vx3_, _vy3_, c="r")
plt.title("runge-kutta dt=0.0001")
plt.xlabel("vx [UA/años]")
plt.grid()
...
plt.subplot(3,3,5)
plt.plot(t2_, L2_, c="b")
plt.title("leap-frog dt=0.001")
plt.xlabel("t (años)")
plt.grid()

plt.subplot(3,3,6)
plt.plot(t3_, L3_, c="b")
plt.title("leap-frog dt=0.0001")
plt.xlabel("t (años)")
plt.grid()

plt.subplot(3,3,7)
plt.plot(_t1_, _L1_, c="r")
plt.title("runge-kutta dt=0.01 \n")
plt.ylabel("L [m_sol*UA^2 / años]")
plt.xlabel("t (años)")
plt.grid()
...
plt.subplot(3,3,8)
plt.plot(_t2_, _L2_, c="r")
plt.title("runge-kutta dt=0.001 \n")
plt.xlabel("t (años)")
plt.grid()

plt.subplot(3,3,9)
plt.plot(_t3_, _L3_, c="r")
plt.title("runge-kutta dt=0.0001 \n")
plt.xlabel("t (años)")
plt.grid()
...
plt.subplot(3,3,5)
plt.plot(t2_, E2_, c="b")
plt.title("leap-frog dt=0.001 \n")
plt.xlabel("t (años)")
plt.grid()

plt.subplot(3,3,6)
plt.plot(t3_, E3_, c="b")
plt.title("leap-frog dt=0.0001 \n")
plt.xlabel("t (años)")
plt.grid()

plt.subplot(3,3,7)
plt.plot(_t1_, _E1_, c="r")
plt.title("runge-kutta dt=0.01 \n")
plt.ylabel("E [m_sol*UA^2 / años^2]")
plt.xlabel("t (años)")
plt.grid()
...
plt.subplot(3,3,8)
plt.plot(_t2_, _E2_, c="r")
plt.title("runge-kutta dt=0.001 \n")
plt.xlabel("t (años)")
plt.grid()

plt.subplot(3,3,9)
plt.plot(_t3_, _E3_, c="r")
plt.title("runge-kutta dt=0.0001 \n")
plt.xlabel("t (años)")
plt.grid()
